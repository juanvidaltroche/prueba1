            ...
            items: [ {
                    ...
                    listeners: {
                        select: function(combo, record, index) {
                          ...
                          nro2 = Ext.getCmp('LABEL_MAGICO').getValue();
                          nroFinal = nro1 + "-" + nro2;
                    ...
                    listeners: {
                        select: function(combo, record, index) {
                          nro1 = Ext.getCmp('LABEL_MAGICO').getValue();
                          nro2 = Ext.getCmp('LABEL_ESTCIVIL').getValue();
                          //var res = nro2.substring(3,6); 
                          nroFinal = nro1 + nro2 + "-";
                          Ext.getCmp('LABEL_MAGICO').setValue(nroFinal);
                        }
                    }
                    ...
                    listeners: {
                        ...
                        listeners: {check: function(){
                            ...
                            if (cb1 == true) {
                                ...
                                Ext.getCmp('LABEL_NOMBRE').setDisabled(false);
