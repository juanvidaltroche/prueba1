				...
				<table id="mytable" class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0" border="0">
					...
					{section name=i loop=$PERSONAL}
						<tr class="odd gradeX">
							...
							<td>
								<button class="btn btn-primary" onclick="this.form.action='rh_ver_matriz.php';this.form.submit();" name="PRS_ID" id="PRS_ID" value="{$PERSONAL[i].FUNCIONARIO_ID}">EVALUACIONES</button>
							</td>
						</tr>
					{/section}
					</tbody>
