	...
	<body>
		...
		<form class="form-horizontal" method="POST" action="rh_guardar.php" id="formulario" name="formulario">  
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="DATOS_DIRECCION" class="form-control" placeholder="Dirección" type="text" name="DATOS_DIRECCION" value="{$ANALISIS[0].DATOS_DIRECCION}">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="DATOS_TELEFONO" class="form-control" placeholder="Teléfono" type="text" name="DATOS_TELEFONO" value="{$ANALISIS[0].DATOS_TELEFONO}">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="DATOS_EMAIL" class="form-control" placeholder="Telefono móvil" type="text" name="DATOS_MOVIL" value="{$ANALISIS[0].DATOS_MOVIL}">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="DATOS_EMAIL" class="form-control" placeholder="Correo electrónico" type="email" name="DATOS_EMAIL" value="{$ANALISIS[0].DATOS_EMAIL}">
				</div>
			</div>
