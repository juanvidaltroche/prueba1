...
acl.application = {
  ...
  var cboAnfitrion = new Ext.form.ComboBox({
    ...
    //alert (sIdAnfitrionI);
		...
		storeRecaudacionPeriodica.reload({ params: {option: "LIST_2", pageSize: pageSize, fechaInicio: sFechaInicio,fechaFinal: sFechaFinal,horaInicio: sHoraInicio,horaFinal: sHoraFinal,anfitrion: sIdAnfitrionI}}); 
    storeGridTotal.reload({ params: {"option": "LST_MONTO2", "pageSize": 1000, fechaInicio: sFechaInicio,fechaFinal: sFechaFinal,horaInicio: sHoraInicio,horaFinal: sHoraFinal,anfitrion: sIdAnfitrionI}});
    ...
    var grdRecaudacion = new Ext.grid.GridPanel({
		...
		plugins: summary,
		tbar: [' FECHA INICIO: ',sFechaInicio, 'FECHA FINAL: ',sFechaFinal, 'HORA INICIO: ',sHoraInicio, 'HORA FINAL: ',sHoraFinal, 'INGRESAR NOMBRE: ',cboAnfitrion, btnBuscarFecha, ' ' , btnPrm],
		bbar: pagingUser,
