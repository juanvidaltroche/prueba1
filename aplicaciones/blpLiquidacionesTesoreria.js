...
var LABEL_TITLE_PANEL_1 = "LIQUIDACIONES POR COBRAR";
var LABEL_TITLE_PANEL_2 = "LIQUIDACIONES COBRADAS";
...
acl.application = {
  init:function(){
    storeUserProcess = function (n, r, i) {
      ...
      myMask.show();
      Ext.Ajax.request({
        url: "../servicios/blpLiquidacionesTesoreriaAjax.php",
        method: "POST",
  ...
  var storeGiros = new Ext.data.GroupingStore({
        ...
        reader:new Ext.data.JsonReader({
            root: "resultRoot",
            totalProperty: "resultTotal",
            fields: [{name: "FECHA", allowBlank: false},
                ...
                buttons: [{
                    ...
                    handler: function() {
                        if(formLiquidacion.getForm().isValid()){
                            ...
                            var vHrr = rec.get('TRX_HERRAMIENTA_ID');
...
///////////////// FIN VENTANA PARA SALDOS Y FALTANTES
  ...
  var btnImprimir = new Ext.Action({
    ...
    handler:     function onImprimir() {
      ...
      vTotalCobrar = parseFloat(vMonto) + parseFloat(vSaldos);
      var url = '../ext/fondo_blanco_1.jpg';
      var sTitulos= vNombre + "|" + vSaldos + "|" + vHRR + "|" + vMonto + "|" + vFlujo + "|" + vConfirmado + "|" + vCajero + "|" + vIdLiq+ "|" + vTipo+ "|" + vTotalCobrar;
 ...
 var btnImprimirMasivo = new Ext.Action({
    ...
    handler:     function onImprimirMasivo() {
                ...
                var url = '../ext/fondo_blanco_1.jpg';
                var sTitulos= "REPORTE MASIVO DE RECAUDO EN SISTEMA| CONFIRMADO | SI CANCELADOS | MONTO RECAUDADO |" + vTotalSI;
    ...
    var cmodel = new Ext.grid.ColumnModel({
      ...
      columns:[{id: "ID", header: "ID", dataIndex: "LQD_ANFITRION", hidden: true, hideable: true, width: 40},
               ...
               {header: "HERRAMIENTA", dataIndex: "HRR_DESCRIPCION", align: "left", hidden: false, hideable: false, width: 50},
               {header: "PROGRAMACION", dataIndex: "TRX_PRG_ID", align: "left", hidden: false, hideable: false, width: 100 },
               ...
               {header: "FECHA SINCRONIZACION", dataIndex: "FECHA", align: "left", hidden: false, hideable: false, width: 150},
  ...
  var cboPageSizeM = new Ext.form.ComboBox({
    ...
    var grdliquidacionSI = new Ext.grid.GridPanel({
      ...
      tbar: [btnImprimir, btnImprimirMasivo],
      store: storeLiquidacionesSI,
      plugins: summary1,
      emptyText: 'No existen registros',
      colModel: cmodelSI,
  ...
  var btnSearch = new Ext.Action({
    ...
    var cmodelG = new Ext.grid.ColumnModel({
      ...
      columns:[{id: "ID", header: "FECHA", dataIndex: "FECHA", hidden: false, hideable: true, width: 50},
               {header: "CANTIDAD", dataIndex: "PASAJES", align: "left", hidden: false, hideable: false, editor: new Ext.form.TextField({})},
