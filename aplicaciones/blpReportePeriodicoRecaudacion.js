  ...
  storeRecaudador.load({ params: {"option": "LST_R", "pageSize": pageSize} });
    ...
    var btnPrm = new Ext.Action({
      ...
      handler: function() {
    		...
    		var sTitulos= "REPORTE PERIODICO DE RECAUDACION |" + "DE: "+fechaIni+ "|"+" HASTA: " + fechaFin + "| TOTAL PERIODO | Bs. "+ sTotalGrilla;				
    ...
    var cmodel = new Ext.grid.ColumnModel({
      ...
      columns:[{id: "ID", header: "ID", dataIndex: "LQD_ID", hidden: false, hideable: true, width: 50},
              ...
              {header: "NOMBRE DE ANFITRION", dataIndex: "ANFITRION_NOMBRE_COMPLETO", align: "left", hidden: false, hideable: false},			   
              {header: "NOMBRE DE CAJERO", dataIndex: "CAJERO_NOMBRE_COMPLETO", align: "left", hidden: false, hideable: false},        
              ...
              {header: "MONTO COBRADO", dataIndex: "MONTO", summaryType: 'sum', align: "right", hidden: false, hideable: false, editor: new Ext.form.TextField({}),        
