...
//        maskRe: /[0-9,-]/
        ...
        newForm = new Ext.FormPanel({
            ...
            items: [{
                ...
                ,{
                  xtype: 'box',
                  autoEl: {cn: '<center><font color="#FF0000">Ejemplo de Nro. de seguridad:  <b> 11-79-23-04 </b></font></center>'}
                }
                ,{
                    xtype: 'textfield',
                    //vtype: 'peNumber',
                                        ...
                                        if (sw == 0) {
                                            newForm.getForm().submit({
                                                ...
                                                success: function (form, action) {
                                                    Ext.MessageBox.alert("Advertencia", "Registro Almacenado correctamente");
                                                    storeFuncionario.reload();                                                    
                                                },
                                                failure: function (form, action) {
                                                    Ext.MessageBox.alert("Advertencia", "El tiempo de sesion expiro, REINICIE EL SISTEMA");
