...
acl.application = {
  ...
  var btnCobrar = new Ext.Action({
    ...
    handler:     function onCobrar() {
      ...
      //alert (url+"/servicios/ctb_PerfilesContablesAjax.php");
      //alert ("Panchito");
      Ext.Msg.confirm('Cobrando: ' + value + ' Pasajes', 'Usted cobrara '+ vTotal +'  <br> esta seguro de querer hacer esto?',function(btn){  
          if(btn === 'yes'){  
              Ext.Ajax.request({
                url: "../servicios/blpLiquidacionesAjax.php",
                method: "POST",
