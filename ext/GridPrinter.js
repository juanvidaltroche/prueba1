...
Ext.ux.GridPrinter = {
 ...
 //////////////////
        ...
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
           '<tr>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px">  '+ vTitulos[3] +' </font></th>',
            '<th width="25%" scope="col"  align="right" ><font face="Arial, Helvetica, sans-serif" size="1px"> '+ vTitulos[4] +'</font></th>',
          '</tr>',
        '</table>',
        '</body>',
      '</html>'
