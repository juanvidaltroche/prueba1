...
Ext.define("Sch.feature.DragCreator", {
    ...
    onDragStart: function () {
        ...
        Sch.util.ScrollManager.activate(a.el, a.getOrientation())
    },
    onDrag: function (h, b) {
        var d = this,
            f = d.schedulerView,
    ...
    constructor: function (c, a) {
        ...
        d.on({
            eventdragstart: function () {
                Sch.util.ScrollManager.activate(d.el, d.constrainDragToResource && d.getOrientation())
            },
...
Ext.define("Sch.feature.DragDrop", {
    ...
    constructor: function (d, a) {
        ...
        if (b) {
            d.eventDragZone = new Sch.feature.SchedulerDragZone(d.ownerCt.el, Ext.apply({
                ddGroup: d.id,
                schedulerView: d,
...
Ext.define("Sch.feature.ResizeZone", {
    ...
    onMouseMove: function (h, a) {
        ...
        h.stopEvent();
        this.resizer = this.createResizer(this.origEl, g, d, h, a);
    ...
    partialResize: function (b, g, n, l) {
        ...
        if (m) {
            ...
            this.getTipInstance().update(f, h, a)
        }
...
Ext.define("Sch.mixin.AbstractSchedulerView", {
    ...
    _initializeSchedulerView: function () {
        ...
        if (a) {
            this.eventLayout.horizontal = new a(Ext.apply({}, b, this.horizontalEventSorterFn ? {
                sortEvents: this.horizontalEventSorterFn
            } : {}))
        }
        if (c) {
            this.eventLayout.vertical = new c(Ext.apply({}, b, this.verticalEventSorterFn ? {
    ...
    onAssignmentUpdate: function (d, f) {
        var a = f.previous[f.resourceIdField];
        ...
        initErrorLogging: function () {
            ...
            c.onerror = function (n, g, o, h, k) {
                ...
                if (!c.__reported && n && (o || g)) {
                    c.__reported = true;
                    try {
                        var f = c.innerWidth || e.documentElement.clientWidth || e.body.clientWidth,
                            d = c.innerHeight || e.documentElement.clientHeight || e.body.clientHeight,
                            l = "";
