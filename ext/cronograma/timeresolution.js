...
App.SchedulerDemo = {
    ...
    init : function() {
        ...
        var sched = new Sch.panel.SchedulerGrid({
            ...
            startDate : new Date(2009, 1, 9, 8),
            endDate : new Date(2009, 2, 9, 16),
            eventResizeHandles : 'both',
            snapToIncrement : true,
            rowHeight : 30,//alto de celda
                ...
                new Ext.slider.SingleSlider({
                    ...
                    listeners : {
                        ...
                        afterrender: function() {
							...
							//alert(sched.getCurrentZoomLevelIndex());
                        }    
                    }
                }),
                '  ',
            ...
            columns : [
                {header : 'Tarea', sortable:true, width:100, dataIndex : 'Name'}
            ],
