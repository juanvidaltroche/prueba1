...
Ext.ux.GridPrinter = {
    ...
    */
    print: function (grid, curl, nomRuta) {
 ...
 //////////////////
        '<table width="100%" border="0" cellspacing="0" cellpadding="0" class="pagedTable">',
          '<tr>',
            '<th width="20%" scope="col"><center><img src="' + vUrl + '" width="85" height="85" /></center></th>',
            '<th width="80%" scope="col"><center><p>GOBIERNO AUTONOMO MUNICIPAL DE LA PAZ</p>',
            '<p>Bus La Paz</p></center></th>',
          '</tr>',
        '</table>',
        '<table width="100%" border="1" cellspacing="0" cellpadding="0" class="pagedTable">',
          '<tr>',
            '<th scope="row" colspan="4"><font face="Arial, Helvetica, sans-serif" size="3px"> <center> BUSES DE LA RUTA - '+ nomRuta +'<br>',
          '</center></font></th>',
          '</tr>',
