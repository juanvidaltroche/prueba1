...
function rowsGet($r, $i) {
    ...
    $sSQL = "SELECT SUM(L.LQD_MONTO) AS TOTAL
			...
			INNER JOIN mb_tipos_funcionario AS TPF ON TPF.TIPO_FUNCIONARIO_ID=F.FUNCIONARIO_TIPO_FUNCIONARIO_ID
            WHERE TPF.TIPO_FUNCIONARIO_DESCRIPCION='RECAUDADORA' AND L.LQD_ESTADO = 'ACTIVO' 
			 ";
			// PRINT( $sSQL);
