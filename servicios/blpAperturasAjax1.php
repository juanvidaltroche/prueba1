    ...
    switch ($option) {
        ...
        case "NEW":
            ...
            $consultaSql = "INSERT INTO mb_liq_manuales
							...
							VALUES ('$sFuncionario', '$sIdUsuario', '$sTipoHrr_Id', '$sRuta_Id', '$variable', '$MONTO', '$sBolivianos', 'SI', 'INGRESO', '$sNroMagico', '$sNormalDiurno', '$sNormalNocturno', '$sPrefDiurno', '$sPrefNoc','$sLiquidacionesUsuario', now(),'$sTipoHrr_Id')
            ";
			//print_r($consultaSql);
			//die();
			//echo $consultaSql;
